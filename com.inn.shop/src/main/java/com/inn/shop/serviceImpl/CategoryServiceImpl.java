        ...
        try {
            if (jwtFilter.isAdmin()) {
                if (validateCategoryMap(requestMap, false)) {
                    ...
                    return MyShopUtils.getResponseEntity("Category Added Successfully", HttpStatus.OK);
                }
            } else {
            ...
            if (jwtFilter.isAdmin()) {
                if (validateCategoryMap(requestMap, true)) {
                    ...
                    if (!optional.isEmpty()) {
                        ...
                        return MyShopUtils.getResponseEntity("Category Updated Successfully",HttpStatus.OK);
                    } else {
                        return MyShopUtils.getResponseEntity("Category id doesn't exist", HttpStatus.OK);
                    }
                }
