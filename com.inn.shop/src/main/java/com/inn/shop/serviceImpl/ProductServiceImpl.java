        ...
        try {
            if (jwtFilter.isAdmin()) {
                if (validateProductMap(requestMap, false)) {
                    ...
                    return MyShopUtils.getResponseEntity("Product Added Successfully.", HttpStatus.OK);
                }
            ...
            if (jwtFilter.isAdmin()) {
                if (validateProductMap(requestMap, true)) {
                    ...
                    if (!optional.isEmpty()) {
                        ...
                        return MyShopUtils.getResponseEntity("Product Updated Successfully.", HttpStatus.OK);
                    } else {
                        return MyShopUtils.getResponseEntity("Product id doesn't exist.", HttpStatus.OK);
                    }
                } else {
                    return MyShopUtils.getResponseEntity(MyShopConstants.INVALID_DATA, HttpStatus.BAD_REQUEST);
                }
        ...
        try {
            if (jwtFilter.isAdmin()) {
                ...
                if (!optional.isEmpty()) {
                    ...
                    return MyShopUtils.getResponseEntity("Product Deleted Successfully.", HttpStatus.OK);
                }
                return MyShopUtils.getResponseEntity("Product id doesn't exist.", HttpStatus.OK);
            } else {
                return MyShopUtils.getResponseEntity(MyShopConstants.UNAUTHORIZED_ACCESS, HttpStatus.UNAUTHORIZED);
        ...
        try {
            if (jwtFilter.isAdmin()) {
                ...
                if (!optional.isEmpty()) {
                    ...
                    return MyShopUtils.getResponseEntity("Product Status Updated Successfully", HttpStatus.OK);
                }
                return MyShopUtils.getResponseEntity("Product id doesn't exist", HttpStatus.OK);
            } else {
                return MyShopUtils.getResponseEntity(MyShopConstants.UNAUTHORIZED_ACCESS, HttpStatus.UNAUTHORIZED);
